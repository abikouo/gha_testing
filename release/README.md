...
- **Release branch**: This workflow is triggered manually to create release branch or push default branch changes into an existing release branch. Example
...
The `GH_TOKEN` secrets is required for workflow to trigger another workflow, for more information see [Github](https://github.com/ad-m/github-push-action/issues/32 we are not using default GITHUB_TOKEN).
